local presets = {
    ...
    ["agonize-twt"] = {"Preset: Agonize 2020", "Guarded Checks", "Relics in Set Locations", "Maximizes backtracking"},
    ...
    ["bounty-hunt"] = {"Preset: Bounty Hunter", "Guarded Checks - Complexity 5", "Vlads are held by Target enemies", 
    ...
    ["cursed-nigh"] = {"Preset: Cursed Night", "Guarded Checks - Complexity 6", "Start Cursed", "Eldritch Shield after Dopp10", "Coral Circlet Removes Cursed status"},
    ...
    ["first-castl"] = {"Preset: First Castle", "Guarded Checks - Complexity 5", "Shortcuts are open from the start", "Start with 2 Library cards", 
    ...
    ["glitch-lega"] = {"Preset: Glitch Legacy"},
    ...
    ["lucky-seven"] = {"Preset: Lucky Sevens", "Guarded Checks - Complexity 7", "Start with 77 in all stats", "7 random Relics at the start", "77% chance for Drops", "All Shortcuts and some Teleporters open",
    ...
    ["magic-mirro"] = {"Preset: Magic Mirror", "Guarded+ Checks - Compleity 6", "Entrance-Outer Wall teleport open", "Modified Castle", "X+Triangle to teleport to other castle"},
    ...
    ["mirror-brea"] = {"Preset: Mirror Breaker", "Guarded+ Checks - Compleity 3", "All Bosses Required", "Start with Grav Boots, Potions and Mirror", "X+Triangle to teleport to other castle"},
    ...
    ["sequence-br"] = {"Preset: Sequence Breaker", "Guarded Checks - Complexity 8", "Requires knowledge of sequence breaks", "All Forms of Dive kicks are in logic"},
    ...
    ["target-conf"] = {"Preset: Target Confirmed", "Guarded Checks - Complexity 6", "Bounty Hunter Variant", "Familiar cards Required for Vlads", "Higher odds to get Drop", 
                    "Reverse Library card enabled"},
    ["third-castl"] = {"Preset: Third Castle", "Guarded Checks - Complexity 9", "April Fools Preset", "Randomizes Tileset Data"},
